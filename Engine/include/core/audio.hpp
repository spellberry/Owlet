...
public:
    ...
    int PlaySoundW(const std::string& filename, const float volume, bool scaleWithFOV = true);
    ...
    /// If the operation failed, this function returns -1 and prints information to the console.</returns>
    int PlaySoundW(const std::string& filename, const float volume);
    ...
    void UpdateListenerPosition(glm::vec3 listenerPos, glm::vec3 listenerVelocity, glm::vec3 listenerForward,
